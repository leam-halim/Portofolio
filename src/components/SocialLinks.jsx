...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/gulamin-halim-581a723a0/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@lamgallagher_13",
    icon: Instagram,
    url: "https://www.instagram.com/lamgallagher_13?igsh=MThpNmRoeTdrMDZ4OQ==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@leam-halim",
    icon: Github,
    url: "https://github.com/leam-halim",
    color: "#ffffff",
